...
// FROM  ddnet/src/engine/client/updater.h
...
public:
	...
	const char *GetBinaryPathAbsolute(const char *pFilename, char *pBuffer, unsigned BufferSize) override
	{
		...
		GetBinaryPath(PLAT_SERVER_EXEC, aBinaryPath, sizeof(aBinaryPath));
	...
	const char *GetDataPath(const char *pFilename, char *pBuffer, unsigned BufferSize) override
	{
