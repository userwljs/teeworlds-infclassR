...
MACRO_CONFIG_INT(SvInactiveKickTime, sv_inactivekick_time, 1, 0, 1000, CFGFLAG_SERVER, "How many minutes to wait before taking care of inactive players")
...
MACRO_CONFIG_INT(SvVoteKickMin, sv_vote_kick_min, 4, 0, MAX_CLIENTS, CFGFLAG_SERVER, "Minimum number of players required to start a kick vote")
