...
MACRO_CONFIG_INT(InfSurvivalRespawnDelay, inf_survival_respawn_delay, 30, 0, 1000, CFGFLAG_SERVER, "Time (in seconds) the player must to wait before respawning after death")
